  ...
  "modulo-2-el-principito": [
    {
      ...
      blocks: [
        {
          type: "paragraph",
          text: "Vive la historia de El Principito como una novela gráfica interactiva: avanza escena a escena con las flechas, deslizando en el móvil o con las teclas ← → del teclado.",
        },
        {
          type: "story",
          ...
          slides: [
            {
              image: "/images/story/story-desert.png",
              alt: "Un pequeño avión averiado sobre las dunas doradas del desierto del Sahara bajo un cielo estrellado.",
              chapter: "Capítulo 1",
              heading: "Un avión en el desierto",
              text: "Hace muchos años, un aviador tuvo una avería con su avión y aterrizó en medio del desierto del Sahara. Estaba completamente solo, a miles de kilómetros de cualquier persona, tratando de reparar su motor bajo un enorme cielo de estrellas.",
            },
            {
              image: "/images/story/story-meeting.png",
              alt: "Un niño de cabello dorado y bufanda verde conoce al aviador en el desierto de noche.",
              chapter: "Capítulo 2",
              heading: "«Dibújame un cordero»",
              text: "Al amanecer, una vocecita lo despertó con una petición extraña: «Por favor… ¡dibújame un cordero!». Así conoció al principito, un niño de cabello dorado que había llegado desde un planeta muy, muy lejano.",
            },
            {
              image: "/images/story/story-b612.png",
              alt: "Un planeta diminuto con tres volcanes y una rosa bajo una cúpula de cristal.",
              chapter: "Capítulo 3",
              heading: "El asteroide B-612",
              text: "El principito venía del asteroide B-612, un planeta tan pequeño como una casa. Allí tenía tres volcanes que limpiaba cada mañana y una rosa única, hermosa y un poco orgullosa, a la que cuidaba con todo su cariño.",
            },
            {
              image: "/images/story/story-baobab.png",
              alt: "Enormes baobabs cuyas raíces amenazan con romper un planeta diminuto.",
              chapter: "Capítulo 4",
              heading: "El peligro de los baobabs",
              text: "En su planeta crecían semillas de baobab. Si no se arrancaban a tiempo, se volvían árboles gigantes capaces de partir el planeta en pedazos. Por eso el principito aprendió que los problemas pequeños hay que atenderlos pronto, antes de que se hagan enormes.",
            },
            {
              image: "/images/story/story-journey.png",
              alt: "El principito viaja por el espacio entre asteroides y estrellas.",
              chapter: "Capítulo 5",
              heading: "El gran viaje",
              text: "Un día, tras discutir con su rosa, el principito decidió viajar para conocer otros mundos. Se despidió de su planeta y partió a explorar el universo, con la esperanza de aprender y hacer nuevos amigos.",
            },
            {
              image: "/images/story/story-planets.png",
              alt: "Varios planetas pequeños, cada uno habitado por un adulto solitario.",
              chapter: "Capítulo 6",
              heading: "Seis adultos curiosos",
              text: "Visitó seis planetas, cada uno con un adulto muy peculiar: un rey que mandaba sin súbditos, un vanidoso que quería ser admirado, un bebedor, un hombre de negocios que contaba estrellas, un farolero muy ocupado y un geógrafo que nunca exploraba. Todos le parecieron un poco extraños.",
            },
            {
              image: "/images/story/story-earth.png",
              alt: "El principito llega a un desierto de la Tierra iluminado por la luna, con una serpiente cerca.",
              chapter: "Capítulo 7",
              heading: "Llegada a la Tierra",
              text: "Por fin llegó a la Tierra, a un desierto silencioso. Allí conoció a una serpiente misteriosa y comenzó a caminar buscando personas, sintiéndose un poco solo bajo el inmenso cielo estrellado.",
            },
            {
              image: "/images/story/story-roses.png",
              alt: "El principito observa triste un jardín con miles de rosas iguales.",
              chapter: "Capítulo 8",
              heading: "El jardín de rosas",
              text: "Entonces encontró un jardín con miles de rosas idénticas a la suya. Se puso triste: creía que su rosa era la única en todo el universo. ¿Sería su flor tan especial como pensaba?",
            },
            {
              image: "/images/story/story-fox.png",
              alt: "El principito y un zorro se hacen amigos en un campo dorado al atardecer.",
              chapter: "Capítulo 9",
              heading: "El zorro y el secreto",
              text: "Un zorro le pidió que lo «domesticara», es decir, que creara un vínculo con él dedicándole tiempo. Así entendió por qué su rosa era única: por todo lo que había cuidado de ella. El zorro le regaló su secreto: «Lo esencial es invisible a los ojos».",
            },
            {
              image: "/images/story/story-farewell.png",
              alt: "El principito mira un cielo lleno de estrellas y se despide.",
              chapter: "Capítulo 10",
              heading: "La despedida",
              text: "El principito comprendió que su rosa lo esperaba y decidió volver a cuidarla. Se despidió del aviador con ternura, dejándole un regalo para siempre: aprender a mirar el mundo con el corazón. Por eso, cuando mires las estrellas, todas parecerán reír.",
            },
          ],
        },
      ],
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              term: "Domesticar",
              definition:
                "Crear un v��nculo único con alguien o algo, dedicándole tiempo y cuidado.",
            },
            {
              emoji: "🌾",
              term: "Esencial",
